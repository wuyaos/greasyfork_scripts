...
// @icon         https://bgm.tv/img/favicon.ico
// @downloadURL  https://cdn.jsdelivr.net/gh/wuyaos/greasyfork_scripts@main/dist/Bangumi_Enhanced.user.js
// @updateURL    https://cdn.jsdelivr.net/gh/wuyaos/greasyfork_scripts@main/dist/Bangumi_Enhanced.user.js
// ==/UserScript==

// Generated from src/scripts/bangumi-enhanced/index.js; do not edit dist files.
"use strict";
(() => {
  var __defProp = Object.defineProperty;
  var __name = (target, value) => __defProp(target, "name", { value, configurable: true });

  // src/scripts/bangumi-enhanced/config.js
  var CONFIG_CALENDAR_ADD_NAV_BUTTON = true;
  var CONFIG_CALENDAR_SHOW_SUBTITLE = true;
  var CONFIG_HOMEPAGE_TINY_MODE_FONT_SIZE = "1.2em";
  var CONFIG_HOMEPAGE_ENABLE_EDIT_BUTTON = false;
  var CONFIG_HOMEPAGE_EDIT_BUTTON_TEXT = "❤";
  var CALENDAR_LEFT_BTN_SVG = `
  ...
  // src/scripts/bangumi-enhanced/calendar.js
  ...
  __name(calendar_addHeaderDateText, "calendar_addHeaderDateText");
  ...
  __name(calendar_completeContent, "calendar_completeContent");
  function calendar_addLinkTarget() {
    document.querySelectorAll(".BgmCalendar a").forEach(function(t) {
      t.setAttribute("target", "_blank");
    });
  }
  __name(calendar_addLinkTarget, "calendar_addLinkTarget");
  function calendar_addControlButtons() {
    ...
    parent.insertBefore(leftBtn, parent.firstChild);
    parent.appendChild(rightBtn);
    const dayWidth = 330;
    const minTranslateX = -(6 * dayWidth);
  ...
  __name(calendar_addControlButtons, "calendar_addControlButtons");

  // src/scripts/bangumi-enhanced/subject-title.js
  function subjectEp_replaceH1Title() {
    ...
    if (h1Link && h1Link.title.trim() !== "" && h1Link.text.trim() !== h1Link.title.trim()) {
      ...
      h1Link.text = h1Link.title;
      const smallOriginalTitle = document.createElement("small");
      smallOriginalTitle.innerText = ` ${originalTitleText} `;
      smallOriginalTitle.style.fontSize = "0.65em";
  ...
  __name(subjectEp_replaceH1Title, "subjectEp_replaceH1Title");
  ...
  __name(homepage_convertTitlesAndButtons, "homepage_convertTitlesAndButtons");

  // src/scripts/bangumi-enhanced/navigation.js
  function global_addCalendarNavButton() {
    ...
    if (navMenu && !navMenu.querySelector('a[href="/calendar"].top.chl')) {
      ...
      if (navMenu.children.length > 1) {
        navMenu.insertBefore(calendarLi, navMenu.children[1]);
      } else {
        navMenu.appendChild(calendarLi);
      }
    }
  }
  __name(global_addCalendarNavButton, "global_addCalendarNavButton");

  // src/scripts/bangumi-enhanced/startup.js
  function bootstrap() {
    applyStyles();
    window.addEventListener("DOMContentLoaded", function() {
      ...
      if (CURRENT_PATHNAME.endsWith("/calendar")) {
        ...
        const homepage_intervalId = setInterval(() => {
          ...
          if (homepage_interval_exec_count >= 80) {
  ...
  // src/scripts/bangumi-enhanced/index.js
  bootstrap();
})();
