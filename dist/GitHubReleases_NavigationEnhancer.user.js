...
// @license       MIT
// @downloadURL   https://cdn.jsdelivr.net/gh/wuyaos/greasyfork_scripts@main/dist/GitHubReleases_NavigationEnhancer.user.js
// @updateURL     https://cdn.jsdelivr.net/gh/wuyaos/greasyfork_scripts@main/dist/GitHubReleases_NavigationEnhancer.user.js
// ==/UserScript==

// Generated from src/scripts/github-releases/index.js; do not edit dist files.
"use strict";
(() => {
  var __defProp = Object.defineProperty;
  var __name = (target, value) => __defProp(target, "name", { value, configurable: true });

  // src/scripts/github-releases/notes-collapser.js
  var ReleaseNotesCollapser = class {
    static {
      __name(this, "ReleaseNotesCollapser");
    }
    constructor() {
  ...
  // src/scripts/github-releases/store.js
  var shallowEqual = /* @__PURE__ */ __name((objA, objB) => {
  ...
  var createStore = /* @__PURE__ */ __name((initialState) => {
  ...
  // src/scripts/github-releases/release-actions.js
  var releaseActions = {
    togglePlatform(platformId) {
      ...
      const availableArchsNow = /* @__PURE__ */ new Set();
      const assetsToConsider = newSelectedPlatforms.size > 0 ? parsedAssets.filter((asset) => asset.info.platform && newSelectedPlatforms.has(asset.info.platform)) : parsedAssets;
    ...
    updateAndSaveAllFilters(select) {
      const { state, setState } = GithubReleaseEnhancer.store;
      if (select) {
        const newSelectedPlatforms = /* @__PURE__ */ new Set();
        ...
        const newSelectedArchs = /* @__PURE__ */ new Set();
        ...
        setState({
          selectedPlatforms: /* @__PURE__ */ new Set(),
          selectedArchs: /* @__PURE__ */ new Set(),
    ...
    initializeFilterStates() {
      ...
      if (state.isMainReleasesPage) {
        ...
        const validatedSelectedPlatforms = /* @__PURE__ */ new Set();
        const validatedSelectedArchs = /* @__PURE__ */ new Set();
        ...
        const selectedArchs = /* @__PURE__ */ new Set();
  ...
  // src/scripts/github-releases/release-settings.js
  var releaseSettings = {
    parseHiddenKeywords(input) {
      ...
      while ((match = regex.exec(input)) !== null) {
        const pattern = (match[1] !== void 0 ? match[1] : match[2]).trim();
        if (pattern) {
    ...
    createSettingsPanel() {
      try {
        ...
        const createCheckboxGroup = /* @__PURE__ */ __name((id, labelKey, checked) => {
        ...
        const createRadioGroup = /* @__PURE__ */ __name((name, value, labelKey, checked) => {
        ...
        const updateSavePrefsBtnState = /* @__PURE__ */ __name(() => {
  ...
  // src/scripts/github-releases/release-page.js
  var navigationReInit;
  var releasePage = {
    observer: {
      start() {
        try {
          ...
          const callback = /* @__PURE__ */ __name((mutationsList) => {
          ...
          console.error(`[GitHub Filter@${location.pathname}] Error starting DOM observer:`, e);
        }
      },
    ...
    navigation: {
      setupListeners() {
        try {
          ...
          navigationReInit = /* @__PURE__ */ __name(() => setTimeout(() => GithubReleaseEnhancer.init(), 100), "navigationReInit");
          document.addEventListener("turbo:load", navigationReInit);
          window.addEventListener("popstate", navigationReInit);
        } catch (e) {
          console.error(`[GitHub Filter@${location.pathname}] Error setting up navigation listeners:`, e);
        }
      }
    }
  };

  // src/scripts/github-releases/release-core.js
  var releaseCore = {
    releaseNotes: {
      initializeExpansion() {
        const GRE = GithubReleaseEnhancer;
    ...
    assetFilter: {
      ...
      preScanAssetsForAvailableFilters() {
        ...
        const availableFilters = /* @__PURE__ */ new Set();
        const masterAvailableArchs = /* @__PURE__ */ new Set();
      ...
      summaryCaptureListener: /* @__PURE__ */ __name(function(event) {
        const GRE = GithubReleaseEnhancer;
        if (event.target.closest(`.${GRE.config.CLASS_NAMES.FILTER_CONTAINER}`)) {
          event.preventDefault();
        }
      }, "summaryCaptureListener"),
      closePopup() {
        const GRE = GithubReleaseEnhancer;
      ...
      createUI() {
        ...
        try {
          ...
          console.error(`[GitHub Filter@${location.pathname}] Error creating filter UI:`, e);
          return null;
        }
      },
      createFilterButton() {
        ...
        const btn = GRE.utils.createElement("button", {
          type: "button",
          className: `btn btn-sm hx_rsm-trigger ${CN.FILTER_BUTTON}`,
      ...
      createPlatformOptions() {
        ...
        if (!state.isTouchDevice) {
          ...
          const clearCloseTimeout = /* @__PURE__ */ __name(() => clearTimeout(popupCloseTimeout), "clearCloseTimeout");
      ...
      createPlatformOptionElement(platform) {
        ...
        const el = createElement("div", {
          className: CN.PLATFORM_OPTION,
          role: "menuitemcheckbox",
          dataset: { platformId: platform.id },
          tabindex: "-1"
        });
        el.appendChild(createElement("span"));
      ...
      updateAllArchTagsVisualState(state) {
        ...
        const parsedAssets = this.getParsedAssets();
        const availableArchsNow = /* @__PURE__ */ new Set();
        const assetsToConsider = state.selectedPlatforms.size > 0 ? parsedAssets.filter((asset) => asset.info.platform && state.selectedPlatforms.has(asset.info.platform)) : parsedAssets;
        assetsToConsider.forEach((asset) => {
        ...
        const setsAreEqual = /* @__PURE__ */ __name((setA, setB) => setA.size === setB.size && [...setA].every((value) => setB.has(value)), "setsAreEqual");
      ...
      filterAssets(state) {
        ...
        parsedAssets.forEach((asset) => {
          ...
          if (assetInfo.isSourceCode) {
            ...
            const passesSupplementary = this.rules.language(assetInfo, state, context) && this.rules.resolution(assetInfo, state, context);
  ...
  // src/scripts/github-releases/release-ui.js
  var releaseUi = {
    styles: {
      commonStylesTemplate() {
        const GRE = GithubReleaseEnhancer;
        const C = GRE.config;
        const CN = C.CLASS_NAMES;
        return `
      ...
      addStyleElement(id, css) {
        try {
          const attr = `data-ghre-style-${id}`;
          let styleElement = document.head.querySelector(`style[${attr}]`);
          if (!styleElement) {
            styleElement = GithubReleaseEnhancer.utils.createElement("style", { "data-ghre-style-id": id, textContent: css });
            document.head.appendChild(styleElement);
          } else if (styleElement.textContent !== css) {
            styleElement.textContent = css;
          }
        } catch (e) {
          console.error(`[GitHub Filter@${location.pathname}] Error adding styles:`, e);
        }
      },
      addGlobalStyles() {
        this.addStyleElement("common", this.commonStylesTemplate());
      },
      updateMaxHeightVar(height) {
        document.documentElement.style.setProperty("--ghre-notes-max-height", `${height}px`);
      }
    },
    theme: {
      watchSystemTheme() {
  ...
  // src/scripts/github-releases/release-utils.js
  var releaseUtils = {
    keywordRegexCache: /* @__PURE__ */ new Map(),
    maxCacheSize: 100,
    ...
    getCurrentPlatform() {
      try {
        if (navigator.userAgentData && navigator.userAgentData.platform) {
          const d = navigator.userAgentData.platform.toLowerCase();
          if (d.includes("win")) return "windows";
      ...
      if (p.startsWith("mac") || p.includes("darwin")) return "macos";
      if (p.startsWith("linux") || p.includes("freebsd")) return "linux";
      if (u.includes("android")) return "android";
      if (u.includes("iphone") || u.includes("ipad") || u.includes("ipod") || p.includes("iphone") || p.includes("ipad") || p.includes("ipod")) return "ios";
      return "unknown";
    },
    async getCurrentArchitecture() {
      try {
        if (navigator.userAgentData?.getHighEntropyValues) {
          const d = await navigator.userAgentData.getHighEntropyValues(["architecture", "bitness"]);
          const a = d.architecture;
          const b = d.bitness;
          if (a === "arm") return b === "64" ? "arm64" : "arm";
          if (a === "x86") return b === "64" ? "x64" : "x86";
          if (a) return a;
        }
      } catch (e) {
      }
      const p = (navigator.platform || "").toLowerCase();
      const u = (navigator.userAgent || "").toLowerCase();
      if (u.includes("arm64") || u.includes("aarch64") || p.includes("arm64") || p.includes("aarch64") || u.includes("armv8")) return "arm64";
      if (u.includes("win64") || u.includes("x64") || u.includes("amd64") || p.includes("64")) return "x64";
      if (u.includes("x86") || p.includes("win32") || p.includes("i386") || p.includes("i686")) {
        if (!u.includes("x64") && !p.includes("64")) return "x86";
      }
      if (u.includes("arm") || p.includes("armv7") || p.includes("armhf")) {
        if (!u.includes("arm64") && !p.includes("arm64")) return "arm";
      }
      return "unknown";
    },
    getCurrentLanguage() {
    ...
    parseAssetInfo(text) {
      try {
        ...
        let detectedPlatform = null, detectedArch = null, detectedLang = null, detectedRes = null;
  ...
  // src/scripts/github-releases/release-platform-rules.js
  var releasePlatformArchRules = {
  ...
  // src/scripts/github-releases/release-icons.js
  var releaseIcons = {
  ...
  // src/scripts/github-releases/release-config.js
  var releaseConfig = {
    ...
    texts: {
      filterButton: { zh: "筛选", en: "Filter" },
      expandButton: { zh: "展开 ▾", en: "Expand ▾" },
      collapseButton: { zh: "收起 ▴", en: "Collapse ▴" },
      settingsPanelTitle: { zh: "脚本设置 - GitHub Releases 优化", en: "Settings - GitHub Releases Enhancer" },
      settingsSaveButton: { zh: "保存设置", en: "Save Settings" },
      settingsCancelButton: { zh: "取消", en: "Cancel" },
      ...
      supplementaryFilterTitle: { zh: "补充筛选", en: "Supplementary Filters" },
      selectAllLabel: { zh: "全选", en: "Select All" },
      deselectAllLabel: { zh: "清空", en: "Clear" },
      restoreLabel: { zh: "恢复", en: "Restore" },
      ...
      archLabel: { zh: "架构", en: "Architecture" },
      allArchLabel: { zh: "所有", en: "all" },
      langLabel: { zh: "语言", en: "Language" },
      resLabel: { zh: "分辨率", en: "Resolution" },
    ...
    PLATFORMS: [
      ...
      { id: "macos", name: "MacOS", exclusiveFormats: [".dmg", ".pkg"] },
      { id: "linux", name: "Linux", exclusiveFormats: [".deb", ".rpm", ".appimage"] },
    ...
    LANGUAGES: {
      ...
      "en": { name: "English", keywords: ["en", "english", "eng"] },
      "fr": { name: "Français", keywords: ["fr", "french", "français", "fra"] },
      "de": { name: "Deutsch", keywords: ["de", "german", "deutsch", "ger", "deu"] },
      "ru": { name: "Русский", keywords: ["ru", "russian", "русский", "rus"] },
      "ja": { name: "日本語", keywords: ["ja", "japanese", "日本語", "jpn", "nihongo"] },
      "ko": { name: "한국어", keywords: ["ko", "korean", "한국어", "kor", "hanguk"] },
      "it": { name: "Italiano", keywords: ["it", "italian", "italiano", "ita"] },
      "es": { name: "Español", keywords: ["es", "spanish", "español", "spa"] },
      "pt": { name: "Português", keywords: ["pt", "portuguese", "português", "por"] },
      "ar": { name: "العربية", keywords: ["ar", "arabic", "العربية", "ara"] }
    },
    RESOLUTIONS: {
    ...
    CLASS_NAMES: {
      ...
      RELEASE_NOTES_PANEL: "my-3",
      TOGGLE_BUTTON: "toggle-button",
      EXPANDED: "expanded",
      FILTER_CONTAINER: "ghre-filter-interaction-wrapper",
      FILTER_BUTTON: "ghre-filter-button",
      PLATFORM_OPTIONS: "ghre-platform-options",
      PLATFORM_OPTIONS_INNER: "ghre-platform-options-inner",
      PLATFORM_OPTIONS_GRID: "ghre-options-grid",
      PLATFORM_OPTIONS_OPEN: "ghre-dropdown-open",
      PLATFORM_OPTION: "ghre-platform-option",
      ARCH_TAG_CONTAINER: "ghre-arch-tag-container",
      ARCH_TAG: "ghre-arch-tag",
      KEYWORD_TOGGLE_OPTION: "ghre-keyword-toggle-option",
      OPTIONS_SEPARATOR: "ghre-options-separator",
      OPTIONS_TITLE: "ghre-options-title",
      SELECTED: "selected",
      HIDDEN_ASSET: "hidden-asset",
      HIDDEN_ASSET_COUNTER: "ghre-hidden-asset-counter",
      SUMMARY_MARKER_ICON: "ghre-summary-marker-icon",
      AVAILABILITY_DOT: "ghre-availability-dot",
      ACTION_BUTTON: "ghre-action-button",
      SETTINGS_PANEL: "ghre-settings-panel",
      SETTINGS_OVERLAY: "ghre-settings-overlay",
      SETTINGS_TITLE: "ghre-settings-title",
      SETTINGS_FORM_GROUP: "ghre-form-group",
      SETTINGS_LABEL: "ghre-settings-label",
      SETTINGS_INPUT: "ghre-settings-input",
      SETTINGS_TEXTAREA: "ghre-settings-textarea",
      SETTINGS_ACTIONS: "ghre-settings-actions",
      SETTINGS_BUTTON: "ghre-settings-button",
      ASSET_LIST_LOADING: "ghre-assets-loading",
      POPUP_HEADER: "ghre-popup-header",
      POPUP_SETTINGS_BTN: "ghre-popup-settings-btn",
      RESET_CONFIRM_DIALOG: "ghre-reset-confirm-dialog"
    },
    SELECTORS: {
      ASSET_ROW: ".Box-row, li.Box-row, .release-asset",
      ASSET_LIST_CONTAINER: ".Box--condensed ul, .release-assets",
      MAIN_CONTENT: "main#main-content, main",
      ASSETS_SUMMARY: 'summary[data-target="details-toggle.summaryTarget"]',
      ASSET_DOWNLOAD_LINK: 'a[href*="/download/"]',
      MAIN_REPO_CONTENT: "main .repository-content",
      FILTER_COUNTER: '[data-ghre-filter-counter="true"]',
      HIDDEN_ASSET_COUNTER: ".ghre-hidden-asset-counter",
      MAIN_ASSET_COUNTER: 'span.Counter:not(.ghre-hidden-asset-counter):not([data-ghre-filter-counter="true"])',
      SETTINGS_MAX_HEIGHT_INPUT: "#ghreMaxHeightInput",
      SETTINGS_HIDDEN_RULES_TEXTAREA: "#ghreHiddenRulesTextarea",
      SETTINGS_CLICK_OUTSIDE_CHECKBOX: "#ghreClickOutsideCheckbox",
      SETTINGS_SAVE_BUTTON: 'button[data-action="save"]',
      SETTINGS_CANCEL_BUTTON: 'button[data-action="cancel"]',
      SETTINGS_RESET_BUTTON: 'button[data-action="reset"]',
      FIRST_FOCUSABLE_OPTION: '[role="menuitemcheckbox"]'
    }
  };

  // src/scripts/github-releases/enhancer.js
  var GithubReleaseEnhancer = {
    store: null,
    _observer: null,
    ...
    async init() {
      try {
        ...
        this.store = createStore({
          ...
          selectedPlatforms: /* @__PURE__ */ new Set(),
          selectedArchs: /* @__PURE__ */ new Set(),
          masterAvailableArchs: /* @__PURE__ */ new Set(),
          availableArchs: /* @__PURE__ */ new Set(),
          hideByKeyword: true,
          hideSourceCode: false,
          currentUserPlatform: "unknown",
          currentUserArchitecture: "unknown",
          currentUserLanguage: "unknown",
          currentUserResolutionCategory: "unknown",
          filterMatchLanguage: false,
          filterMatchResolution: false,
          isMainReleasesPage: false,
          filterUIInstance: null,
          settingsOverlayElement: null,
          isDropdownOpen: false,
          availableFilters: /* @__PURE__ */ new Set(),
          releaseNotesMaxHeight: 0,
          hiddenKeywords: [],
          clickOutsideToCollapse: true,
  ...
  // src/scripts/github-releases/startup.js
  ...
  // src/scripts/github-releases/index.js
  bootstrap();
})();
